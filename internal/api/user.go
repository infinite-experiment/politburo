...
func (h *Handlers) InitUserRegistrationV2() http.HandlerFunc {
	return InitUserRegistrationHandlerV2(h.deps.Services.RegV2)
}

func (h *Handlers) InitServerRegistrationV2() http.HandlerFunc {
	return InitServerRegistrationHandlerV2(h.deps.Services.RegV2)
}

func (h *Handlers) LinkUserToVA() http.HandlerFunc {
	return LinkUserToVAHandler(h.deps.Services.RegV2)
}
...
func (h *Handlers) VerifyGodMode() http.HandlerFunc {
	return VerifyGodModeHandler()
}
